/**
 * Clase que hereda de EmpleadoArtesano y simula un artesano contratado por horas.
 */
public class ArtesanoPorHora extends EmpleadoArtesano
{
    /**
     * Constructor.
     ...
     */
    public ArtesanoPorHora(String nombre, int id, int telefono, String direccion, double sueldo)
    {
    ...
    public String toString() {
    	return "Artesano por hora: " +super.toString();
    }
}
